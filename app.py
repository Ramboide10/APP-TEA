...
# Devido ao RENDER:
from waitress import serve  # Para produção no Render
...
APP_URL = os.environ.get('APP_URL', 'https://app-tea.onrender.com')  # Default para sua URL no Render
#------------------------------------------------------------------+
...
def home():
    ...
    <div style="font-family: Arial; text-align: center; margin-top: 50px;">
        <h2>Aplicativo de Avaliação TEA</h2>
        <p>Acesse <a href="/predict?token=TEA12345">/predict?token=TEA12345</a> para ver os resultados</p>
    </div>
    """
...
#---------------------------------------------+
        ...
        return Response(resultado_html, mimetype='text/html') # Resposta do Servidor Web para o usuário
